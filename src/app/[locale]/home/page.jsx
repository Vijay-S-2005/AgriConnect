...
export default function HomePage() {
  ...
  return (
    <>
    <div className="relative w-full max-w-[100vw] h-[80vh] overflow-hidden">  {/* Adjusted height to 80vh */}
    ...
    <div className="relative group">
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center justify-center mb-4">
        ...
        <div className="bg-white py-6 px-6 rounded-md shadow-lg text-center w-3/4 h-40 relative">
          ...
          <p className="text-green-600 font-bold text-2xl mt-10">Agriculture Products</p>
        </div>
      </div>
    </div>
    ...
    <div className="relative group">
      ...
      <div className="bg-white py-6 px-6 rounded-md shadow-lg text-center w-3/4 h-40 relative">
          ...
          <p className="text-green-600 font-bold text-2xl mt-10">Organic Products</p>
        </div>
      </div>
    </div>
    ...
    <div className="relative group">
      ...
      <div className="bg-white py-6 px-6 rounded-md shadow-lg text-center w-3/4 h-40 relative">
          ...
          <p className="text-green-600 font-bold text-2xl mt-10">Fresh Vegetables</p>
        </div>
      </div>
    </div>
    ...
    <div className="relative group">
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center justify-center mb-4">
        <div className="bg-white py-6 px-6 rounded-md shadow-lg text-center w-3/4 h-40 relative">
          ...
          <p className="text-green-600 font-bold text-2xl mt-10">Dairy <br /> Products</p>
        </div>
      </div>
    </div>
  </div>
...
<div className="flex justify-center py-10">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col items-center bg-white shadow-lg rounded-lg p-6 text-center w-64">
          ...
          <h3 className="text-xl font-semibold mb-4">Direct Farmer-to-Consumer Sales</h3>
          <Image
        ...
        <div className="flex flex-col items-center bg-white shadow-lg rounded-lg p-6 text-center w-64">
          ...
          <h3 className="text-xl font-semibold mb-4">Seamless Order Management</h3>
          <Image
        ...
        <div className="flex flex-col items-center bg-white shadow-lg rounded-lg p-6 text-center w-64">
          ...
          <h3 className="text-xl font-semibold mb-4">Sustainable & Transparent Sourcing</h3>
          <Image
...
<div className="flex items-center justify-center p-10  bg-white">
  ...
  <div className="flex items-start max-w-6xl pl-52">
    ...
    {/* Text section */}
    <div className="w-1/2  ">  {/* Reduced padding on the left side */}
      <h1 className="text-4xl font-bold text-gray-800">
        Agriculture & Organic Product Farm
      </h1>
      <p className="mt-2 text-lg text-gray-500"> {/* Reduced margin-top */}
        <span className="font-bold text-green-600">AgriConnect</span> is the largest global organic farm. At AgriConnect, we bridge the gap between farmers and consumers...
      </p>

      <ul className="mt-4 space-y-2"> {/* Reduced margin-top and list item spacing */}
        <li className="flex items-center">
          <span className="text-green-600 mr-2">✔</span> Reach more buyers, expand your market.
        </li>
        <li className="flex items-center">
          <span className="text-green-600 mr-2">✔</span> Choose from a variety of fresh products.
        </li>
      </ul>
    </div>
  </div>
    ...
    <div className="max-w-7xl mx-auto py-12 px-6 lg:px-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-center">
          <h4 className="text-sm font-semibold text-yellow-500 mb-2">Our Farm Benefits</h4>
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Why Choose AgriConnect Market</h2>
          <p className="text-gray-600 mb-6">
            There are many variations of passages of available but the majority have suffered alteration in some form by injected humor or random words which don't look even.
          </p>
          ...
          <ul className="space-y-4">
            <li className="flex items-center space-x-4">
              ...
              <div>
                <h4 className="text-lg font-semibold text-gray-800">Quality Organic Food</h4>
                <p className="text-sm text-gray-600">There are variation. You need to be sure there is anything hidden in the middle of text.</p>
              </div>
            </li>
            <li className="flex items-center space-x-4">
              <span className="bg-green-500 text-white rounded-full p-2">
              ...
              <div>
                <h4 className="text-lg font-semibold text-gray-800">Professional Farmers</h4>
                <p className="text-sm text-gray-600">There are variation. You need to be sure there is anything hidden in the middle of text.</p>
              </div>
            </li>
            <li className="flex items-center space-x-4">
